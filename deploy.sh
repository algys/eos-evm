...
eos-tester cleos --wallet-url=http://localhost:6666 set code evm /host/build/evm.wasm

# set evm contract abi
eos-tester cleos --wallet-url=http://localhost:6666 set abi evm /host/build/evm.abi
